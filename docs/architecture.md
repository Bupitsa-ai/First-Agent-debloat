...
> Справочный документ research/design-фазы First-Agent: трёхслойная
> архитектура LLM-агента + базовые паттерны. Двуязычный (RU комментарий
> + EN термины) — намеренно, для удобного цитирования. Источники:
